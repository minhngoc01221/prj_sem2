...
const MyOrderPage = () => {
  ...
  if (!user) {
    return (
      <div className="myorder-container">
        <h2 className="myorder-title">
          Vui lòng <a href="/login">đăng nhập</a> để xem thông tin đơn hàng.
        </h2>
      </div>
    );
  }
  ...
  if (orders.length === 0) {
    return (
      <div className="myorder-container">
        <h2 className="myorder-title">Bạn chưa có đơn hàng nào.</h2>
      </div>
    );
  }
